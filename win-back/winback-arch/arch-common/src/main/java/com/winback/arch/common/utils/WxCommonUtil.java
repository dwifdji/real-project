...
public class WxCommonUtil {
     ...
     * @return
     */
    public static com._360pai.core.model.assistant.AccessToken getAccessToken(String appid, String appsecret) {
        com._360pai.core.model.assistant.AccessToken accessToken = null;
        String                                       requestUrl  = ACCESS_TOKEN_URL.replace("APPID", appid).replace("APPSECRET", appsecret);
        // 发起GET请求获取凭证
        JsonNode rootNode = httpsRequest(requestUrl, "GET", null);

        if (null != rootNode.get("access_token")) {
            accessToken = new com._360pai.core.model.assistant.AccessToken();
     ...
     * @return
     */
    public static com._360pai.core.model.assistant.JsApiTicket getJsApiTicket(String accessToken) {
        String requestUrl = JSAPI_TICKET_URL.replace("ACCESS_TOKEN", accessToken);
        // 发起GET请求获取凭证
        JsonNode                                     rootNode    = httpsRequest(requestUrl, "GET", null);
        com._360pai.core.model.assistant.JsApiTicket jsApiTicket = null;
        if (null != rootNode.get("ticket")) {
            jsApiTicket = new com._360pai.core.model.assistant.JsApiTicket();
