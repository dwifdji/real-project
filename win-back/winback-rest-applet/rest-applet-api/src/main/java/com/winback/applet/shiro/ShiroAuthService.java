package com.winback.applet.shiro;
...
public class ShiroAuthService {
    ...
    private String sessionKey = SystemConstant.APPLET_SESSION_KEY;
    private String cookieIdName = SystemConstant.APPLET_COOKIE_ID_NAME;
    private String cookieTicketName = SystemConstant.APPLET_COOKIE_TICKET_NAME;
