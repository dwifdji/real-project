...
//            new Test_Data(4294967295, "四十二亿九千四百九十六万七千二百九十五")
    ...
    public static String getTenThousandOfANumber(Double num) {
        ...
        return  rvZeroAndDot(new DecimalFormat("#0.000000").format(num / 10000d));
    ...
    public static BigDecimal getFormatTenThousand(BigDecimal bigDecimal){
        if(bigDecimal != null) {
    ...
    public static BigDecimal getFormatMonth(BigDecimal bigDecimal){
        if(bigDecimal != null) {
     ...
     *将数字字符串四舍五入处理
     */
    public static String getFormatNumStr(String str ,int num){
        if(StringUtils.isEmpty(str)) {
             return str;
        }

        BigDecimal formatNum = new BigDecimal(str).setScale(num,BigDecimal.ROUND_HALF_DOWN);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getFormatNumStr("",2));
