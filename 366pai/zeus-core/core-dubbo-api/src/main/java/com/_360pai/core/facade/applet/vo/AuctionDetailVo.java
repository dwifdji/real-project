...
public class AuctionDetailVo implements Serializable {
    ...
    private Boolean favorStatus;//关注状态
    ...
    private Boolean remarkStatus;//提醒状态
    ...
    private String assetCategoryGroupId;//模板id
    private Boolean isDealPerson;//是否是成交的人
    private String buyerId;//模板id
    private Boolean hasExist;//是否添加过了
    private Long beginTimestamp;
    private Long endTimestamp;
    private String incrementAt;
    private Long incrementTimestamp;
    private Long currentTimestamp;
    private String reduction;//降价幅度
    private String reductionPeriod;//降价延迟周期
    private String reducedAt;//降价时间
    private String commissionPercentBuyer;//佣金比例
