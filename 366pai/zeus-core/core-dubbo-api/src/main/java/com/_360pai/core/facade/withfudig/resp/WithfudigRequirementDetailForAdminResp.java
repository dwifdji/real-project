 ...
 */
@Data
public class WithfudigRequirementDetailForAdminResp implements Serializable {
    /**
     *
     */
    private Integer    id;
     ...
     * 融资利息 开始利息 %
     */
    private BigDecimal requirementInterestPercentStart;
    /**
     * 融资利息 结束利息 %
     */
    private BigDecimal requirementInterestPercentEnd;
    /**
     * 融资期限 月
     */
    private BigDecimal requirementTerm;
    /**
