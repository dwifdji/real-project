 ...
 * @Description:
 * @date 29/08/2018 13:32
 */
public class PersonaReq implements Serializable {
    ...
    /**
     * 用户状态 10 电话空号、20 电话无人接听、30 不愿意合作、40 已建立沟通、50 已展开合作、60 接听电话被拒绝、70电话号码错误
     */
    ...
    private PersonaAssetPartyReq personaAssetParty;

    private PersonaBidderReq personaBidder;

    private PersonaDisposalPartyReq personaDisposalParty;

    private PersonaFundingAgencyReq personaFundingAgency;

    private PersonaIntermediaryOrganReq personaIntermediaryOrgan;

    private PersonaUnionAuctionAgencyReq personaUnionAuctionAgency;
    ...
    public PersonaAssetPartyReq getPersonaAssetParty() {
        return personaAssetParty;
    }

    public void setPersonaAssetParty(PersonaAssetPartyReq personaAssetParty) {
        this.personaAssetParty = personaAssetParty;
    }

    public PersonaBidderReq getPersonaBidder() {
        return personaBidder;
    }

    public void setPersonaBidder(PersonaBidderReq personaBidder) {
        this.personaBidder = personaBidder;
    }

    public PersonaDisposalPartyReq getPersonaDisposalParty() {
        return personaDisposalParty;
    }

    public void setPersonaDisposalParty(PersonaDisposalPartyReq personaDisposalParty) {
        this.personaDisposalParty = personaDisposalParty;
    }

    public PersonaFundingAgencyReq getPersonaFundingAgency() {
        return personaFundingAgency;
    }

    public void setPersonaFundingAgency(PersonaFundingAgencyReq personaFundingAgency) {
        this.personaFundingAgency = personaFundingAgency;
    }

    public PersonaIntermediaryOrganReq getPersonaIntermediaryOrgan() {
        return personaIntermediaryOrgan;
    }

    public void setPersonaIntermediaryOrgan(PersonaIntermediaryOrganReq personaIntermediaryOrgan) {
        this.personaIntermediaryOrgan = personaIntermediaryOrgan;
    }

    public PersonaUnionAuctionAgencyReq getPersonaUnionAuctionAgency() {
        return personaUnionAuctionAgency;
    }

    public void setPersonaUnionAuctionAgency(PersonaUnionAuctionAgencyReq personaUnionAuctionAgency) {
        this.personaUnionAuctionAgency = personaUnionAuctionAgency;
    }

    public static class PersonaAssetPartyReq implements Serializable {
        private Integer id;
        private Integer personaId;
        /**
    ...
    public static class PersonaBidderReq implements Serializable {
        private Integer id;
        private Integer personaId;
        /**
    ...
    public static class PersonaDisposalPartyReq implements Serializable {
        private Integer id;
        private Integer personaId;
        /**
         ...
         * 口估
         */
        private Boolean oralEvaluate = false;
        /**
         * 口估费用
         */
         ...
         * 评估报告
         */
        private Boolean evaluateReport = false;
        /**
         * 评估报告费用
         */
    ...
    public static class PersonaFundingAgencyReq implements Serializable {
        private Integer id;
        private Integer personaId;
        /**
         * 资金来源
    ...
    public static class PersonaIntermediaryOrganReq implements Serializable {
        private Integer id;
        private Integer personaId;
        /**
    ...
    public static class PersonaUnionAuctionAgencyReq implements Serializable {
        private Integer id;
        private Integer personaId;
        /**
