 ...
 */
public class TPersonaCondition implements DaoCondition {
	 ...
	 * 录入人员模糊匹配
	 */
	private String dataEntryStaffLike;
	/**
	 * 联系人手机号模糊匹配
	 */
	...
	public String getDataEntryStaffLike() {
		return dataEntryStaffLike;
	}

	public void setDataEntryStaffLike(String dataEntryStaffLike) {
		this.dataEntryStaffLike = dataEntryStaffLike;
	}
