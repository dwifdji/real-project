...
import com._360pai.seimi.service.JdPmService;
...
public class JdPmCrawler extends BaseSeimiCrawler {
    ...
    private static final String ITEM_URL = "https://mpaimai.jd.com/json/mobile/getProductbasicInfo.html?paimaiId=CODE&callback=";

    private static final String NUM_URL = "https://paimai.jd.com/json/ensure/queryAccess?t=991500sku=&paimaiId=CODE";

    private static final String REMIND_URL = "https://api.m.jd.com/api?jsonp=&appid=auctionRemind&functionId=queryRemind&body=%7B%22id%22%3A%22" + "CODE" + "%22%2C%22remindType%22%3A1%7D&rand=" + System.currentTimeMillis() / 1000 + "&_=" + System.currentTimeMillis() / 1000;

    @Override
    public String[] startUrls() {
        return new String[]{"https://auction.jd.com/getAssetsList.html?" +
