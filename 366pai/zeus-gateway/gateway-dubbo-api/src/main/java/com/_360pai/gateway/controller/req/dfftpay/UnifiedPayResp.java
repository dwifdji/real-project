...
public class UnifiedPayResp implements Serializable {
    ...
    private List<BatchPayInfoVo> bathPayInfo;//批量返回的参数
    ...
    public List<BatchPayInfoVo> getBathPayInfo() {
        return bathPayInfo;
    }

    public void setBathPayInfo(List<BatchPayInfoVo> bathPayInfo) {
        this.bathPayInfo = bathPayInfo;
    }
