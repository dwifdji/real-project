package com.tzCloud.web.shiro;

import com.alibaba.fastjson.JSONObject;
import com.tzCloud.arch.common.utils.RequestUtils;
...
public class ShiroAuthService {
    ...
    private String sessionKey = SystemConstant.PLATFORM_SESSION_KEY;
    private String cookieIdName = SystemConstant.PLATFORM_COOKIE_ID_NAME;
    private String cookieTicketName = SystemConstant.PLATFORM_COOKIE_TICKET_NAME;

    private int cookieMaxAge = 24 * 3600;
    ...
    public String saveTicket(HttpServletRequest request, HttpServletResponse response, Integer id) {
        ...
        idCk.setPath("/");
        idCk.setMaxAge(cookieMaxAge);

        // 设置ticket cookie
        Cookie ticketCk = new Cookie(cookieTicketName, ticket);
        ticketCk.setPath("/");
        ticketCk.setMaxAge(cookieMaxAge);
