...
public class SystemProperties {
    ...
    private String mycatUrl;
    private String mycatUsername;
    private String mycatPassword;
    ...
    @DisconfFileItem(name = "jdbc.mycat.url")
    public String getMycatUrl() {
        return mycatUrl;
    }

    @DisconfFileItem(name = "jdbc.mycat.username")
    public String getMycatUsername() {
        return mycatUsername;
    }

    @DisconfFileItem(name = "jdbc.mycat.password")
    public String getMycatPassword() {
        return mycatPassword;
    }




    public void setMycatUrl(String mycatUrl) {
        this.mycatUrl = mycatUrl;
    }

    public void setMycatUsername(String mycatUsername) {
        this.mycatUsername = mycatUsername;
    }

    public void setMycatPassword(String mycatPassword) {
        this.mycatPassword = mycatPassword;
    }
