...
public class DateUtil {
     ...
     * 标准日期格式
     */
    public final static String SPECIAL_DATE_PATTERN = "yyyy.MM.dd";

    /**
     * 标准日期格式
     */
    public final static String SPECIAL_DATE_ONLY_PATTERN = "yyyy.MM";
...
//        }
    ...
    public static String formatStrDate(String dateStr, String format) {


        return new SimpleDateFormat(format).format(DateUtil.parse(dateStr,format));
    }
     ...
     * @return
     */
    public static String getRecentMonth(Date date, int monthNum,String formatStr){
        Calendar c = Calendar.getInstance();
     ...
     * @return
     */
    public static String getRecentMonth(Date date, int monthNum){
        Calendar c = Calendar.getInstance();
        SimpleDateFormat format = new SimpleDateFormat(SPECIAL_DATE_PATTERN);
     ...
     * @return
     */
    public static Date getRecentMonthDate(Date date, int monthNum){
        Calendar c = Calendar.getInstance();
     ...
     * @return
     */
    public static String getRecentOnlyMonth(Date date, int monthNum){
        Calendar c = Calendar.getInstance();
        SimpleDateFormat format = new SimpleDateFormat(SPECIAL_DATE_ONLY_PATTERN);
