...
public class HttpUtilNew {
    ...
    public static HttpUtilNewModel getUTF(Map<String, String> headers, List<Cookie> cookies, String url, boolean ignoreAllCert) {
        return req(headers, cookies, REQ_TYPE_GET, null, url, GET_HTML, REQ_PARAMS_ARRAY, CHARSET_UTF8, ignoreAllCert);
    }
    ...
    public static HttpUtilNewModel post(Map<String, String> headers, NameValuePair[] nvps, String url, int retType) {
        return req(headers, null, REQ_TYPE_POST, nvps, url, retType, REQ_PARAMS_ARRAY, CHARSET_UTF8, false);
    }
    ...
    public static HttpUtilNewModel post(Map<String, String> headers, List<Cookie> cookies, NameValuePair[] nvps, String url, int reqType, double reqParamType, String charset, boolean ignoreAllCert) {
        return req(headers, cookies, REQ_TYPE_POST, nvps, url, reqType, reqParamType, charset, ignoreAllCert);
    }
